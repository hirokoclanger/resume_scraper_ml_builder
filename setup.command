...
echo "  2. (Optional) Drop a headshot into assets/  — accepted names:"
echo "         assets/photo.jpg   (or .jpeg / .png)"
echo "     The renderer auto-crops it to a square and places it in the"
echo "     top-right of every PDF. assets/ is gitignored, so it stays local."
echo "  3. Build the bullet corpus from your master sentences markdown:"
echo "       .venv/bin/python tailor/extract_corpus.py"
echo "  4. Start the server (any of these — they all auto-use .venv):"
